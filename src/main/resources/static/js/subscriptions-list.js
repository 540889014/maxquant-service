    ...
    methods: {
        ...
        async loadSubscriptions() {
            try {
                ...
                const response = await axios.get(`${BASE_URL}/subscription/user?username=${this.username}`, {
        ...
        async unsubscribe(sub) {
            ...
            try {
                ...
                const response = await axios.post(`${BASE_URL}/subscription/unsubscribe`, null, {
                    params: params,
                    headers: { Authorization: `Bearer ${token}` }
                });

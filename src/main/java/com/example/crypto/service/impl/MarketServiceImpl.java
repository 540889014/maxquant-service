...
public class MarketServiceImpl implements MarketService {
    ...
    @Override
    public List<KlineDataDTO> getKlineData(String symbol, String timeframe, Long startTime, Long endTime, String exchange) {
        try {
            ...
            logger.error("獲取 K 線數據失敗: symbol={}, timeframe={}, exchange={}, error={}", symbol, timeframe, exchange, e.getMessage(), e);
